...
import { EstimateWizard } from "@/components/features/EstimateWizard";
        ...
        <section className={styles.hero}>
            <div className={styles.container}>
                <div className={styles.content}>
                    ...
                    {/* Heading - Broader, outcome driven */}
                    <h1 className={styles.title}>
                        Votre électricien<br />
                        <span className={styles.highlight}>de confiance</span>
                    </h1>

                    {/* Subheadline - Compact */}
                    <p className={styles.subtitle}>
                        Bruxelles &amp; alentours • Devis gratuit 24h • Travail garanti
                    </p>
                    ...
                    <div className={styles.ctas}>
                        ...
                        <a href="tel:+32489986209" className={styles.phoneCta}>
                            +32 489 98 62 09
                        </a>
                    </div>

                    {/* Trust indicators - Compact with SVG icons */}
                ...
                {/* Right side - Wizard + Stats compact */}
